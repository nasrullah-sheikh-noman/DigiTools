  ...
  return (
    <div>
      <div className='bg-[#4F39F6] py-10 my-18'>
        <div className='max-w-250 mx-auto justify-between grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
          <div className='space-y-2'>
            <h2 className='font-bold text-7xl text-white'>50K</h2>
            <h5 className='text-gray-300 text-2xl'>Active Users</h5>
          </div>
          <div className="hidden lg:visible divider divider-horizontal before:bg-white after:bg-white"></div>
          <div className='space-y-2'>
