...
const Steps = () => {
  return (
    <div className="max-w-300 mx-auto">
      <div className="mx-2 sm:mx-4 md:mx-6 lg:mx-8 justify-center items-center text-center space-y-3 my-38">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="border border-gray-400 rounded-lg px-6 py-10 space-y-3.5 bg-gray-50 hover:scale-102 lg:hover:scale-105 transition transform duration-300">
